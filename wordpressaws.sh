...
mysql -uroot -p -e "CREATE DATABASE wordpressdb /*\!40100 DEFAULT CHARACTER SET utf8 */;"
mysql -uroot -p -e "CREATE USER wordpressuser@localhost IDENTIFIED BY '<wppassword>';"
mysql -uroot -p -e "GRANT ALL PRIVILEGES ON wordpressdb.* TO wordpressuser@localhost IDENTIFIED BY '<wppassword>';"
